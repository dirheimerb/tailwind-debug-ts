export interface PluginUtils {
    ...
    rgb(arg: string): (arg: Partial<{
        opacityVariable: string;
        opacityValue: number;
    }>) => string;
    hsl(arg: string): (arg: Partial<{
        opacityVariable: string;
        opacityValue: number;
    }>) => string;
}
...
export declare const twConfig: import("tailwindcss/types/config").Config;
 ...
 * @returns {void}
 */
export declare const debugScreens: {
